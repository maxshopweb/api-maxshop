...
router.get('/active', marcasController.getAllActive.bind(marcasController));
...
router.patch('/:id/activo', adminAuth, marcasController.toggleActivo.bind(marcasController));
router.patch('/toggle-all', adminAuth, marcasController.toggleAllActivos.bind(marcasController));
